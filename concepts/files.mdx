...
<Note>
Use managed files for simplicity. Use [Storage Buckets](/dashboard/storage) for large datasets or when you need files in your own cloud.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Storage Buckets" icon="database" href="/dashboard/storage">
    BYO storage setup
  </Card>
</CardGroup>
